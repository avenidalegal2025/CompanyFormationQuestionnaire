...
export default function HeroMiami1({
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl h-64 sm:h-80">
      <video
        ...
        onLoadStart={() => console.log('Miami1 video loading started')}
        onLoadedData={() => console.log('Miami1 video data loaded')}
        onCanPlay={() => console.log('Miami1 video can play')}
        onPlay={() => console.log('Miami1 video playing')}
        onError={(e) => console.log('Miami1 video error:', e)}
        onLoad={() => console.log('Miami1 video loaded')}
      >
