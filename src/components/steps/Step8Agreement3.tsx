        ...
        <div className="mt-6 space-y-24 md:pl-12">
          {isCorp ? (
            ...
            <>
              ...
              <div className="mt-20 pt-16 border-t border-gray-300 bg-gray-50/30 rounded-lg p-6 md:grid md:grid-cols-[minmax(420px,1fr)_minmax(420px,auto)] md:gap-8 md:items-start">
                <div>
