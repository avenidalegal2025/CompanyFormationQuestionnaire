...
export const AgreementSchema = z
  .object({
    ...
    corp_responsibilityDesc_0: z.string().optional(),
    corp_responsibilityDesc_1: z.string().optional(),
    corp_responsibilityDesc_2: z.string().optional(),
    corp_responsibilityDesc_3: z.string().optional(),
    corp_responsibilityDesc_4: z.string().optional(),
    corp_responsibilityDesc_5: z.string().optional(),
    corp_hasSpecificResponsibilities: z.enum(["Yes", "No"]).optional(),
    corp_hoursCommitment: z.string().optional(),
    // C-Corp capital & loans
    corp_newShareholdersAdmission: z.enum(["Decisión Unánime", "Supermayoría", "Mayoría"]).optional(),
    corp_newShareholdersMajority: z.number().min(50.01).max(99.99).optional(),
    corp_moreCapitalProcess: z.enum(["Sí, Pro-Rata", "No"]).optional(),
    corp_moreCapitalDecision: z.enum(["Decisión Unánime", "Supermayoría", "Mayoría"]).optional(),
    ...
    corp_shareholderLoansVoting: z.enum(["Decisión Unánime", "Supermayoría", "Mayoría"]).optional(),
    corp_shareholderLoansVotingMajority: z.number().min(50.01).max(99.99).optional(),
    // C-Corp governance & decisions
    corp_saleDecisionThreshold: z.enum(["Decisión Unánime", "Supermayoría", "Mayoría"]).optional(),
    ...
    corp_majorDecisionThreshold: z.enum(["Decisión Unánime", "Supermayoría", "Mayoría"]).optional(),
    corp_majorDecisionMajority: z.number().min(50.01).max(99.99).optional(),
    corp_majorSpendingThreshold: z.string().optional(),
    corp_nonCompete: z.enum(["Yes", "No"]).optional(),
    corp_nonCompeteDuration: z.number().min(1).max(5).optional(),
    corp_nonCompeteScope: z.string().optional(),
    corp_nonSolicitation: z.enum(["Yes", "No"]).optional(),
    corp_confidentiality: z.enum(["Yes", "No"]).optional(),
    corp_officerRemovalVoting: z.enum(["Decisión Unánime", "Supermayoría", "Mayoría"]).optional(),
    corp_officerRemovalMajority: z.number().min(50.01).max(99.99).optional(),
    ...
    llc_roleDesc_0: z.string().optional(),
    llc_roleDesc_1: z.string().optional(),
    llc_roleDesc_2: z.string().optional(),
    llc_roleDesc_3: z.string().optional(),
    llc_roleDesc_4: z.string().optional(),
    llc_roleDesc_5: z.string().optional(),
    // LLC capital & loans
    llc_newMembersAdmission: z.enum(["Decisión Unánime", "Supermayoría", "Mayoría"]).optional(),
    llc_newMembersMajority: z.number().min(50.01).max(99.99).optional(),
    llc_additionalContributions: z.enum(["Sí, Pro-Rata", "No"]).optional(),
    llc_additionalContributionsDecision: z.enum(["Decisión Unánime", "Supermayoría", "Mayoría"]).optional(),
    ...
    llc_memberLoansVoting: z.enum(["Decisión Unánime", "Supermayoría", "Mayoría"]).optional(),
    llc_memberLoansVotingMajority: z.number().min(50.01).max(99.99).optional(),
    // LLC governance & decisions
    llc_companySaleDecision: z.enum(["Decisión Unánime", "Supermayoría", "Mayoría"]).optional(),
    ...
    llc_nonCompeteDuration: z.number().min(1).max(5).optional(),
    llc_nonCompeteScope: z.string().optional(),
    llc_nonSolicitation: z.enum(["Yes", "No"]).optional(),
    llc_confidentiality: z.enum(["Yes", "No"]).optional(),
    llc_nonDisparagement: z.enum(["Yes", "No"]).optional(),
    llc_bankSigners: z.enum(["Un firmante", "Dos firmantes"]).optional(),
    llc_majorDecisions: z.enum(["Decisión Unánime", "Supermayoría", "Mayoría"]).optional(),
    llc_majorDecisionsMajority: z.number().min(50.01).max(99.99).optional(),
    llc_majorSpendingThreshold: z.string().optional(),
    llc_minorDecisions: z.enum(["Decisión Unánime", "Supermayoría", "Mayoría"]).optional(),
    llc_minorDecisionsMajority: z.number().min(50.01).max(99.99).optional(),
    llc_officerRemovalVoting: z.enum(["Decisión Unánime", "Supermayoría", "Mayoría"]).optional(),
    llc_officerRemovalMajority: z.number().min(50.01).max(99.99).optional(),
