...
def force_focus(driver, element):
...
def main():
    ...
    try:
        ...
        # === Fix problematic credit card field ===
        card_input = wait.until(EC.presence_of_element_located((By.ID, "CCCardNumber")))
        force_focus(driver, card_input)
        human_typing(card_input, payment["cc_number"])
