...
# Deploy Lambda function with Firefox layer for company name availability checking
...
LAYER_NAME="firefox-geckodriver-layer"
...
echo "Creating Firefox layer..."

# Use a pre-built Chrome layer ARN
# This is a public layer that contains Chrome and ChromeDriver
# No layers needed for requests/BeautifulSoup approach

echo "Deploying Lambda function with Firefox layer..."
